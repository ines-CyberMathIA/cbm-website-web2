...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    {
      title: 'Relations utilisateurs',
      path: '/admin/dashboard/relations',
  ...
  return (
    <div className="h-screen w-64 bg-indigo-800 text-white">
      <div className="p-6">
        <h2 className="text-2xl font-bold">Admin CyberMathIA</h2>
      </div>
      <nav className="mt-6">
        {menuItems.map((item) => (
          <Link
